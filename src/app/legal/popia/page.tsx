      ...
      <main className="pt-28 pb-24 px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-16 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight">POPIA Compliance</h1>
          ...
          <div className="rounded-2xl p-6 sm:p-8 bg-gray-50 ring-1 ring-gray-100 mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Our POPIA Commitment</h2>
            ...
            <div className="grid sm:grid-cols-4 gap-4">
              {[
                ...
                <div key={item.title} className="text-center p-4 rounded-xl bg-white ring-1 ring-gray-100">
                  <div className="mx-auto h-10 w-10 rounded-xl bg-sky-100 flex items-center justify-center mb-3">{item.icon}</div>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">The 8 Conditions of Lawful Processing</h2>
            <p className="text-sm text-gray-500 leading-relaxed -mt-3">POPIA sets out eight conditions for the lawful processing of personal information. Here is how Slip a Tip complies with each:</p>
            ...
            {[
              ...
              <div key={item.num} className="rounded-2xl p-6 bg-gray-50 ring-1 ring-gray-100 flex items-start gap-5">
                <div className="h-10 w-10 rounded-xl bg-sky-100 flex items-center justify-center shrink-0 text-sm font-bold text-sky-600">
                  {item.num}
                </div>
                <div>
          ...
          <div className="mt-12 rounded-2xl p-6 sm:p-8 bg-gray-50 ring-1 ring-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-5">Personal Information We Collect</h2>
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={item.category} className="rounded-xl p-4 bg-white ring-1 ring-gray-100">
                  <h3 className="text-sm font-semibold text-gray-900 mb-1">{item.category}</h3>
                  <p className="text-xs text-gray-500 leading-relaxed">{item.items}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Third party sharing */}
          <div className="mt-8 rounded-2xl p-6 sm:p-8 bg-gray-50 ring-1 ring-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-3">Third-Party Disclosure</h2>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={item.party} className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-gray-900">{item.party}</span>
          ...
          <div className="mt-8 rounded-2xl p-6 sm:p-8 bg-sky-50 ring-1 ring-sky-200 text-center">
            <h2 className="text-lg font-bold text-gray-900 mb-2">Exercise Your Rights</h2>
            <p className="text-sm text-gray-500 mb-5">You have the right to access, correct, or delete your personal information at any time.</p>
