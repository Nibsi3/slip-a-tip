      ...
      <main className="pt-28 pb-24 px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-16 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight">FICA Compliance</h1>
          ...
          {/* Tiered FICA */}
          <div className="rounded-2xl p-6 sm:p-8 bg-gray-50 ring-1 ring-gray-100 mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Our Tiered FICA Approach</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="rounded-2xl bg-white ring-1 ring-gray-100 overflow-hidden">
                <div className="px-6 py-4 border-b border-sky-100 bg-sky-50">
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-sky-200 flex items-center justify-center text-xs font-bold text-sky-700">T1</div>
                    <div>
                      <h3 className="text-base font-bold text-gray-900">Tier 1 — Instant</h3>
                      <p className="text-[11px] text-gray-500">Required at registration</p>
                    </div>
                  </div>
                </div>
                <div className="p-6 space-y-3">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <p className="text-xs text-gray-400">Allows: Receiving tips + withdrawals up to R3,000 cumulative</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-white ring-1 ring-gray-100 overflow-hidden">
                <div className="px-6 py-4 border-b border-amber-100 bg-amber-50">
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-amber-200 flex items-center justify-center text-xs font-bold text-amber-700">T2</div>
                    <div>
                      <h3 className="text-base font-bold text-gray-900">Tier 2 — Hard FICA</h3>
                      <p className="text-[11px] text-gray-500">Triggered at R3,000 cumulative</p>
                    </div>
                  </div>
                </div>
                <div className="p-6 space-y-3">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-3">
                      <div className="h-5 w-5 rounded-full bg-amber-100 flex items-center justify-center shrink-0 mt-0.5">
                        <svg className="h-2.5 w-2.5 text-amber-600" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                      </div>
                      <span className="text-sm text-gray-600">{item}</span>
                    </div>
                  ))}
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <p className="text-xs text-gray-400">Allows: Unlimited withdrawals (subject to velocity limits)</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">Integrated Security Framework</h2>
            ...
            {[
              ...
              {
                icon: (<svg className="h-5 w-5 text-sky-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>),
              ...
              <div key={item.title} className="rounded-2xl p-6 bg-gray-50 ring-1 ring-gray-100 flex items-start gap-5">
                <div className="h-10 w-10 rounded-xl bg-sky-100 flex items-center justify-center shrink-0">{item.icon}</div>
                <div>
          ...
          <div className="mt-8 rounded-2xl p-6 sm:p-8 bg-sky-50 ring-1 ring-sky-200 text-center">
            <h2 className="text-lg font-bold text-gray-900 mb-2">Questions About FICA?</h2>
            <p className="text-sm text-gray-500 mb-5">Our compliance team is available to assist with any verification queries.</p>
